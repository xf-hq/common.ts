...
export class Detail<TType extends string | number = string | number, TRefs = unknown> {
  constructor (private readonly _args: Detail.Args<TType, TRefs>) {}
  #label: string;
  #description: string;
   ...
   * relates to).
   */
  get domain (): Detail | undefined { return this._args.domain; }
  ...
  get sources (): Detail[] | undefined { return this._args.sources; }
...
export namespace Detail {
  export interface Args<TType extends string | number, TRefs> {
    readonly type: TType;
    readonly domain?: Detail;
    readonly label?: string;
    readonly description?: string;
    readonly refs?: TRefs;
    readonly sources?: Detail[];
    formatLabel? (args: Args<TType, TRefs>, detail: Detail<TType, TRefs>): string;
    formatDescription? (args: Args<TType, TRefs>, detail: Detail<TType, TRefs>): string;
  }
}
